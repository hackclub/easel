...
Ok. We both have a steaming pile of pancakes. (I hoped you found the secret [redacted] pancake recipe. 🤭 It tastes very good, contrary to popular belief.)
...
Comments are dictated by the tilde symbol. Me and Orpheus have decided that it looks pretty similar to her eyebrows when she's surprised by something, and comments help you when you're surprised by a pie ce of code, so we've decided that it's a pretty effective way of annotating our comments.
