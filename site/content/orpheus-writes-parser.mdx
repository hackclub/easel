...
<aside>
  I thought the obsession was over pancakes? When did we start talking about Froot Loops.
</aside>
...
- Last but not least in Easel - if-else statements are blocks of expressions with, you guessed it, attached metadata like what conditions we should check for.
