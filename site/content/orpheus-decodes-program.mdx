...
What if we took a look at the source of the easel? It looks something like this:
...
Ooh, Orpehus. You know what we should do? We should celebrate with a picnic.
...
Interested? If you're a teenager, Hack Club is running a programming language jam from now (May 01) ntil June 30. Write a programming language, get a terminal-in-a-box that can run your programming language!
